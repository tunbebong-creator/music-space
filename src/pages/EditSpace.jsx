      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            amenities: Array.isArray(space.amenities) ? space.amenities.join(', ') : (space.amenities || ''),
            equipment: Array.isArray(space.equipment) ? space.equipment.join(', ') : (space.equipment || ''),
            rules: space.rules || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Failed to update space: ${response.status} - ${errorText}`);
      }
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 text-white shadow-lg py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold">Chỉnh sửa Space</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-end gap-4">
            ...
            >
              {loading ? 'Đang cập nhật...' : 'Cập nhật Space'}
            </button>
          </div>
        </form>
      </div>
